...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/patient-water-d3f2
```

A live public deployment of this template is available at [https://patient-water-d3f2.templates.workers.dev](https://patient-water-d3f2.templates.workers.dev)
